...
const INPUT_FILE = path.join(__dirname, '../data/nbcot-sources/OTPF_4th_Edition.pdf');
const OUTPUT_TEXT = path.join(__dirname, '../data/nbcot-sources/OTPF_4th_Edition_extracted.txt');
const OUTPUT_CHUNKS = path.join(__dirname, '../data/nbcot-sources/OTPF_4th_Edition_chunks.json');
...
async function processOTPF4() {
  console.log('Processing OTPF-4 PDF...\n');
  ...
  try {
    ...
    console.log('\n✅ Successfully processed OTPF-4 PDF!');
...
processOTPF4().catch(console.error);
